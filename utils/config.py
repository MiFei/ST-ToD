...
parser.add_argument(
    '-patience','--patience', help='patience for early stopping', required=False, default=5, type=int)
parser.add_argument(
...
parser.add_argument(
    '--gpu', help='', required=False, default='0', type=str)
parser.add_argument(
    '--eval_by_epoch', help='', required=False, default=1, type=int)
parser.add_argument(
...
parser.add_argument(
        '--confidence_selection', default=True, type=bool, help="whether to use confidence-based sample selection for unlabeled data")
parser.add_argument(
        "--lambda", default=1.0, type=float, help="base weight assign to the loss of pesudo labeled samples")
parser.add_argument(
        '--confidence_weighting', action='store_true', help="whether to weight the loss of pesudo labeled samples differently based on  confidences")
parser.add_argument(
        '--embedding_noise', action='store_true', help="whether to add N(0, 1) to input embedding")
parser.add_argument(
        '--noise_weight_type', default="samplewise", type=str, help="weight the gaussian noise by sample or by sample('samplewise) of embedding vec('elementwise')")
...
parser.add_argument(
        "--new_candidate_num", default=200, type=int, help="The number of new candidate unlabeled samples")
parser.add_argument(
        "--confidence_top_ratio", default=1., type=float, help="the ratio of selected unlabeled samples based on confidence")
parser.add_argument(
        "--iterations", default=30, type=int, help="the total number of iterations")
